...
public class EyeGazeCursor : MonoBehaviour
{
    ...
    {        
        ...
        transform.position = Vector3.Lerp(visualComponent.transform.position, ValueConverter.MakeUnityVector3(obj.worldPosition), 0.5f);
        transform.rotation = Quaternion.FromToRotation(visualComponent.transform.forward, ValueConverter.MakeUnityVector3(-obj.forwardVector));
    }
}
